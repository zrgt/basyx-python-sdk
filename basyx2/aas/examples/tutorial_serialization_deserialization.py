...
submodel = model.Submodel(
    ...
    submodel_element={
        model.Property(
            ...
            value_type=basyx2.aas.model.datatypes.String,
            value='exampleValue',
...
aashell_json_string = json.dumps(aashell, cls=basyx2.aas.adapter.json.AASToJsonEncoder)

property_json_string = json.dumps(submodel.submodel_element.get_referable('ExampleProperty'),
                                  cls=basyx2.aas.adapter.json.AASToJsonEncoder)
...
# simple Python dicts:
submodel_and_aas = json.loads(json_string, cls=basyx2.aas.adapter.json.AASFromJsonDecoder)
...
with open('data.json', 'w', encoding='utf-8') as json_file:
    basyx2.aas.adapter.json.write_aas_json_file(json_file, obj_store)
...
with open('data.xml', 'wb') as xml_file:
    basyx2.aas.adapter.xml.write_aas_xml_file(xml_file, obj_store)
...
with open('data.json', encoding='utf-8-sig') as json_file:
    json_file_data = basyx2.aas.adapter.json.read_aas_json_file(json_file)
...
with open('data.xml', 'rb') as xml_file:
    xml_file_data = basyx2.aas.adapter.xml.read_aas_xml_file(xml_file)
